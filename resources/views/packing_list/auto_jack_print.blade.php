...
<head>
    ...
    <title>Automatic Packing List</title>
    <style>
        body {
...
<body onLoad="window.print()">
    ...
    <div class="header-section" style="page-break-inside: avoid; margin-bottom: 10px;">
        <table style="font-size:12px; border-collapse:collapse; width:100%;">
            <tr>
                ...
                <td style="padding:8px;" colspan="2">{{ $po_date }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding:8px;" colspan="5">{{ $po->vendor_com_adr }}</td>
            </tr>
            <tr>
                <th style="background-color:#bbb; padding:8px; vertical-align:top;">Ship to Address</th>
                <td style="padding:8px;" colspan="5">{{ $po->vendor_del_adr }}</td>
            </tr>
            @php $info = json_decode($po->article_info, true); @endphp
            <tr>
                ...
                <td style="padding:8px;" colspan="2">{{ $color }}</td>
            </tr>
            <tr>
                ...
                <td style="padding:8px;">{{ $po->po_num }}</td>
    ...
    <table class="items-table">
        ...
        <tbody class="{{ $cls }}" @if($force) style="page-break-before: always;" @endif>
            ...
            $breadth = $item->carton->breadth ?? 0;
            $height = $item->carton->height ?? 0;
        ...
        <tr>
            ...
            <td colspan="3"></td>
            <td><strong>{{ $grandNet > 0 ? round($grandNet, 2) : '' }}</strong></td>
            <td><strong>{{ $grandGross > 0 ? round($grandGross, 2) : '' }}</strong></td>
            <td></td>
        </tr>
    </table>
