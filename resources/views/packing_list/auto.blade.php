                        ...
                        <div class="mb-3">
                            ...
                            if (cartonOrder.length > 0) {
                                ...
                                cartonOrder.forEach(function(cartonName) {
                                    ...
                                    // Calculate net and gross weight for carton (same for all items in carton)
                                    var netWeight = items[0].net_weight || 0;
                                    var grossWeight = netWeight > 0 ? netWeight + 1.2 : 0;
                                    grandNet += netWeight;
                                ...
                                `;
                                        ...
                                        if (itemIndex === 0) {
                                            tableHtml += `
                                        <td rowspan="${itemCount}" style="vertical-align: middle;">${netWeight > 0 ? netWeight : ''}</td>
