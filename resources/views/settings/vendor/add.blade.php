                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="nav-basic" role="tabpanel">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control form-control-sm" id="mobile" name="mobile" placeholder="Mobile" required>
                    ...
                    <div class="tab-pane" id="nav-billing" role="tabpanel">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control form-control-sm" id="billing_legal_name" name="billing_legal_name" placeholder="Legal Name" required>
                                    <label for="billing_legal_name">Legal Name</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <label for="billing_state_id">State</label>
                                <select class="form-control select2" id="billing_state_id" name="billing_state_id" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <textarea class="form-control" id="billing_address_1" name="billing_address_1" placeholder="Address Line 1" style="height: 80px" required></textarea>
                                    <label for="billing_address_1">Address Line 1</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <textarea class="form-control" id="billing_address_2" name="billing_address_2" placeholder="Address Line 2" style="height: 80px"></textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="billing_city_town_village" name="billing_city_town_village" placeholder="City/Town/Village" required>
                                    <label for="billing_city_town_village">City/Town/Village</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="billing_pincode" name="billing_pincode" placeholder="Pincode" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="billing_gst_no" name="billing_gst_no" placeholder="GST No" required>
                                    <label for="billing_gst_no">GST No</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="billing_pan_no" name="billing_pan_no" placeholder="Pan No" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control form-control-sm" id="billing_gst_type" name="billing_gst_type" placeholder="GST Type" required>
                    ...
                    <div class="tab-pane" id="nav-shipping" role="tabpanel">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control form-control-sm" id="shipping_legal_name" name="shipping_legal_name" placeholder="Legal Name">
                                    <label for="shipping_legal_name">Legal Name</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <label for="shipping_state_id">State</label>
                                <select class="form-control select2" id="shipping_state_id" name="shipping_state_id">
                                    <option value="">Choose State</option>
                                    @foreach($states as $state)
                                    <option value="{{ $state->id }}">{{ $state->name }}</option>
                                    @endforeach
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <textarea class="form-control" id="shipping_address_1" name="shipping_address_1" placeholder="Address Line 1" style="height: 80px"></textarea>
                                    <label for="shipping_address_1">Address Line 1</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <textarea class="form-control" id="shipping_address_2" name="shipping_address_2" placeholder="Address Line 2" style="height: 80px"></textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="shipping_city_town_village" name="shipping_city_town_village" placeholder="City/Town/Village">
                                    <label for="shipping_city_town_village">City/Town/Village</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="shipping_pincode" name="shipping_pincode" placeholder="Pincode">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="shipping_gst_no" name="shipping_gst_no" placeholder="GST No">
                                    <label for="shipping_gst_no">GST No</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="shipping_pan_no" name="shipping_pan_no" placeholder="Pan No">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control form-control-sm" id="shipping_place_supply" name="shipping_place_supply" placeholder="Place Supply">
