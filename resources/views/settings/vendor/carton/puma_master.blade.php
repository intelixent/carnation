            ...
            <div class="card">
                ...
                <div class="card-body">
                    <nav class="nav nav-style-6 nav-pills mb-3 nav-justified d-sm-flex d-block" role="tablist">
                        ...
                        <a class="nav-link active" data-bs-toggle="tab" role="tab" href="#nav-puma" aria-selected="true" href="{{route('carton_puma_master')}}">Puma</a>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active text-muted" id="nav-puma" role="tabpanel">
                            <div class="row">
                                <div class="col-xl-12">
