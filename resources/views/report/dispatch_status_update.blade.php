                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <select class="form-control" id="unit_no" name="unit_no">
                                ...
                                <option value="Unit 1" {{ ($GrnDetails['unit_no'] ?? '') == 'Unit 1' ? 'selected' : '' }}>Unit 1</option>
                                <option value="Unit 3" {{ ($GrnDetails['unit_no'] ?? '') == 'Unit 3' ? 'selected' : '' }}>Unit 3</option>
                                <option value="Subcon" {{ ($GrnDetails['unit_no'] ?? '') == 'Subcon' ? 'selected' : '' }}>Subcon</option>
                            </select>
